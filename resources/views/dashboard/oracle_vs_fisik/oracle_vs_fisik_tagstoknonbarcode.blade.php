<div class="col-12 h-100 d-flex flex-column bg-white border rounded-3 p-3 shadow-sm"
    ...
    <div class="w-100 d-flex align-items-center justify-content-between pb-3 mb-2 border-bottom flex-shrink-0 no-print">
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <input type="file" id="nonbarcode-file" class="form-control form-control-sm" accept=".xlsx,.xls"
                style="width: 260px;">

            <select id="nonbarcode-wh" class="form-control form-control-sm" style="width: 180px;">
            ...
            <button type="button" id="btn-upload-nonbarcode" class="btn btn-sm btn-success fw-bold">
...
<script>
    $(document).ready(function() {
        console.log("-> HTML Sub-Menu Non-Barcode berhasil di-load ke DOM!");

        // Taruh script upload langsung di sini agar mengikat langsung ke tombol yang baru di-render
        $(document)
            .off("click", "#btn-upload-nonbarcode")
            .on("click", "#btn-upload-nonbarcode", function() {
                console.log("-> TOMBOL CLICK BERHASIL DI-TRIGGER DI BLADE!");
                    ...
                    try {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                // Panggil filter refresh pencarian
                                if (typeof loadTagStockInitialFilters === "function") {

        ...
        <div class="card shadow-sm border-0 d-flex flex-column h-100"
            ...
            <div class="card-header py-2 d-flex justify-content-between align-items-center"
                ...
                <h5 class="card-title mb-0 small fw-bold text-uppercase d-flex align-items-center flex-shrink-0 me-3">
                    ...
                    Tag Stock (Data Perhitungan Fisik)
                </h5>
            ...
            <div class="col-12 h-100 d-flex flex-column bg-white border rounded-3 p-3 shadow-sm"
                ...
                <div
                    class="w-100 d-flex align-items-center justify-content-between pb-3 mb-2 border-bottom flex-shrink-0 no-print">
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-1 d-none" id="doc-filter-container">
                        ...
                        <form id="form-tagstock" method="POST" action="/appkso/tag-stock/print" target="_blank">
                            @csrf
                            ...
                            <div class="d-flex gap-1">
                                <button type="button" id="btn-tag-stock"
                                    ...
                                    <i data-lucide="printer" class="me-1" style="width: 14px; height: 14px;"></i> TAG
                                    STOCK
                                </button>
                ...
                <div id="print-header-laporan" class="d-none w-100 mb-3 text-dark">
                    ...
                    <table style="width: 100%; border: none !important; margin-bottom: 15px; font-size: 13px;">
                        <tr style="border: none !important;">
                            <td
                                style="width: 10%; text-align: left; font-weight: bold; border: none !important; padding: 2px 0;">
                                PIC</td>
                            <td style="width: 90%; text-align: left; border: none !important; padding: 2px 0;">: <span
                                    id="print-pic-name" class="fw-bold">-</span></td>
                        </tr>
                        <tr style="border: none !important;">
                            <td style="text-align: left; font-weight: bold; border: none !important; padding: 2px 0;">Area
                            </td>
                            <td style="text-align: left; border: none !important; padding: 2px 0;">: <span
                                    id="print-area-lot" class="fw-bold">-</span></td>
                        </tr>
                    </table>
                </div>
                    ...
                    <div class="table-responsive h-100" id="print-scroll-box"
                        ...
                        <table class="table table-sm table-hover align-middle mb-0" id="table-view-tagstock-list"
                            ...
                            <tbody id="tbody-tagstock-rows">
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-5 border-0">Silakan pilih target
                                        gudang dan operator di atas untuk memilah baris area bro.</td>
                                </tr>
                            </tbody>
                            ...
                            <tfoot id="tfoot-tagstock-summary"
                                ...
                                <tr>
                                    <td colspan="5" class="text-end py-2 text-dark bg-light border-dark">TOTAL
                                        RINGKASAN PENUGASAN :</td>
                                    <td id="total-summary-rack"
                                        class="text-center text-danger font-monospace bg-light border-dark">
                                        0 RAK</td>
                                    <td id="total-summary-qty"
                                        class="text-end text-primary font-monospace bg-light border-dark">0
                                        PCS</td>
    ...
    @push('scripts')
        <script>
            function testKlik() {
                ...
                // Kita panggil fungsi validasi lu
                // PENTING: Pastikan fungsi executeValidasiData ada di tag_stock.js
                // Kita panggil manual di sini:
        ...
        <script src="{{ asset('js/appkso/tag_stock.js') }}?v={{ rand() }}"></script>
    @endpush
@endsection

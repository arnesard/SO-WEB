(!(function (e, t) {
        ...
        oe = function (e) {
            ...
            if (e.type)
                if (-1 !== Object.keys(g).indexOf(e.type)) {
                    ...
                    (U(o),
                        e.animation &&
                            N(o, "swal2-animate-".concat(e.type, "-icon")));
                } else
                    R(
    ...
    var je = function (e) {
        ...
        (null !== e.onBeforeOpen &&
            ...
            e.onBeforeOpen(n),
            e.animation
                ? (N(n, D.show), N(t, D.fade), z(n, D.hide))
                : z(n, D.fade),
            U(n),
            ...
            _main: function (e) {
                ...
                return new Promise(function (t, n) {
                    ...
                    for (
                        var l = function (t) {
                                if (
                                    (T.showLoaderOnConfirm && j.showLoading(),
                                    T.preConfirm)
                                ) {
                    ...
                    (le.keydownHandlerAdded &&
                        ...
                        T.toast ||
                                        ...
                                        if ("Tab" === e.key) {
                                            ...
                                            [
                                                ...
                                                : ("Escape" !== e.key &&
                                                  ...
                                                  (e.preventDefault(),
                                                  c(j.DismissReason.esc));
                                    else if (
                                        e.target &&
                                        L.getInput() &&
                                        e.target.outerHTML ===
                                            L.getInput().outerHTML
                                    ) {
                                        if (
                                            -1 !==
                            ...
                            (le.keydownTarget = T.keydownListenerCapture
                                ? window
                                : M.popup),
                    ...
                    switch (T.input) {
                        ...
                        case "url":
                            ...
                            break;
                        case "file":
                            (((d = W(M.content, D.file)).placeholder =
                                T.inputPlaceholder),
                                (d.type = T.input),
                                U(d));
                            break;
    ...
    function Re() {
        if ("undefined" != typeof window) {
            ...
            for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
                t[n] = arguments[n];
            if (0 === t.length)
                return (R("At least 1 argument is expected!"), !1);
            Ve = this;
    ...
    "undefined" != typeof window &&
        window.Sweetalert2 &&
        ((window.Sweetalert2.version = "7.28.11"),
        (window.swal =
            window.sweetAlert =
            window.Swal =
            window.SweetAlert =
